...
def main() -> None:
    ...
    parser.add_argument("--db", required=True, help="Path to SQLite DB (e.g. ./local.db)")
    parser.add_argument("--out", default="data/metadata_graph_manual.json", help="Output graph JSON")
